...
function drawArcToSvg(draw, drawOpts) {
  ...
  var startAngle = 180.0 / Math.PI * Math.atan2(startY - -draw.pos.y, startX - draw.pos.x);
  var endAngle = 180.0 / Math.PI * Math.atan2(endY - -draw.pos.y, endX - draw.pos.x);

  // swap
  //convertCenterArcToSvgOpts 180 0 {"cx":0,"cy":-100,"rx":200,"ry":200,"theta1":180,"delta":-180,"phi":0} undefined undefined browserify.js:1292
  //drawArcToSvg(results) [{"_name":"path","_attrs":{"d":"M -199.99999914153125 -99.9814692820679 A 200 200 0 0 0 200 -100","fill":"none","style":"stroke: rgb(0,0,0); stroke-width: 2"}}] undefined undefined undefined undefined browserify.js:1292

  //convertCenterArcToSvgOpts 0 180 {"cx":0,"cy":-100,"rx":200,"ry":200,"theta1":0,"delta":180,"phi":0} undefined undefined browserify.js:1292
  //drawArcToSvg(results) [{"_name":"path","_attrs":{"d":"M 200 -100 A 200 200 0 0 1 -199.99999914153125 -99.9814692820679","fill":"none","style":"stroke: rgb(0,0,0); stroke-width: 2"}}] undefined undefined undefined undefined browserify.js:1292

  var convertCenterArcToSvgOpts = {
    ...
    theta1: startAngle, // beginning angle of arc in degrees
    delta: endAngle - startAngle, // arc extent in degrees
    phi: 0 // x-axis rotation angle in degrees
  };
  log('convertCenterArcToSvgOpts', startAngle, endAngle, JSON.stringify(convertCenterArcToSvgOpts));
  var vals = mathHelpers.convertCenterArcToSvg(convertCenterArcToSvgOpts);

  if (transformMapAngle(draw.t1, draw.t2)) {
    vals.sweep = vals.sweep = 0 ? 1 : 0;
  }
